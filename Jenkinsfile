pipeline {
  ...
  stages {
    ...
    stage('Deploy Image') {
      steps{
        script {
          docker.withRegistry( 'default-route-openshift-image-registry.cpat-dev-sandbox-ocp44-cs-afb9c6047b062b44e3f1b3ecfeba4309-0000.us-east.containers.appdomain.cloud/client-demo/sampleapp', registryCredential ) {
